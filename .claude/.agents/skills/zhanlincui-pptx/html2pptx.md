...
1. [Creating HTML Slides](html2pptx.md#creating-html-slides)
2. [Using the html2pptx Library](html2pptx.md#using-the-html2pptx-library)
3. [Using PptxGenJS](html2pptx.md#using-pptxgenjs)
